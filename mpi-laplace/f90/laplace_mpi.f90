...
program mpitest
      use mpi
      ! include    'mpif.h'   ! this causes a lot of issues with bcast function, switching to the modern MPI module use mpi
      ...
      print *, "Kind of dA_global:", kind(dA_global)
      print *, "Kind of max_iterations:", kind(max_iterations)
